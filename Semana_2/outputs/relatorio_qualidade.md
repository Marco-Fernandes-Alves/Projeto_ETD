...
Validação das Ações Tiingo (Staging)
 ...
 Schema & Tipos LVMUY: 344 registos validados com sucesso.
 Unicidade IDEXY: Datas das ações são únicas.
 Schema & Tipos IDEXY: 343 registos validados com sucesso.
Validação de Sentimento Diário (Staging)
 Unicidade: Datas dos scores de sentimento são únicas.
Schema & Tipos: 23 registos de sentimento validados com sucesso.
Validação do Dataset Integrado (Camada Gold)
Unicidade: Datas de negócios da Camada Gold são estritamente únicas.
INFO: Detetados valores nulos nas colunas: ['nike_close', 'nike_volume', 'lvmh_close', 'lvmh_volume', 'inditex_close', 'inditex_volume'] (Serão validados via Pydantic como opcionais).
Schema & Sanidade Gold: 353 registos consolidados validados e aprovados.
==================================================
